...
class GetUserInfoContext : ContextBase, QiWa.Common.IResettable
{
    public ReadonlyGetUserInfoRequest Request;
    public GetUserInfoResponse Response;
    ...
    public async ValueTask<Error> Run()
    {
        ...
        try
        {
            GetUserInfoRequest temp = default;
            req.Clone(ref temp);
            temp.ToJSON(ref buf);
